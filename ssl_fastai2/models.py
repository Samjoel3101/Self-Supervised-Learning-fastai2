...
__all__ = ['CGDResNet', 'arch_map', 'rep_resnet', 'L2Norm', 'lin_layer', 'BatchDropBlock', 'RepresentationHead',
           'create_bottleneck', 'SSLModel', 'ImageRepEncoder', 'SIMClrHead']
...
class SSLModel(nn.Module):
  def __init__(self, encoder, global_rep = [nn.AdaptiveAvgPool2d(1), Flatten()],
...
class SIMClrHead(nn.Module):
  def __init__(self, rep_dim):
    ...
    self.relu = nn.ReLU()
    self.lin2 = nn.Linear(1024, rer_dim)
